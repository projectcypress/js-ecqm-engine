...
module.exports = class Handler {
  ...
  finish(connection) {
    var Individual_Result = connection.model('Qdm_Individual_Result', IndividualResultSchema);
    if (this.finished) {
      ...
      Object.keys(this.individualResultsByMeasureId).forEach((measureId) => {
        Object.keys(this.individualResultsByMeasureId[measureId]).forEach((patientId) => {
          ...
          const patientResultMongo =
            Individual_Result(this.individualResultsByMeasureId[measureId][patientId]
              .toObject());
